...
- The **QUERTY** keyboard prevented typists locking up from going too fast, but has become locked-in
...
- Generate proprietary formats if you must!


# Plain text formats

- Lightweight, small file sizes e.g. vs .ppt
- No software version incompatibility (old Word can't open new word)
- Future-proof
- Machine-readable
- Portable
...
- there is an emergng standard: [CommonMark](http://commonmark.org/)

-------------

## is easy to read/write/edit

> The aim is to make it easy to read, write, and edit prose. HTML is a publishing format; Markdown is a writing format…

## easy sharing between devices and people

> Unlike cumbersome word processing applications, text written in Markdown can be easily shared between computers, mobile phones, and people. It’s quickly becoming the writing standard for academics, scientists, writers… Websites… use Markdown to style… comments.
...
Maintained by [Fletcher Penney](http://fletcherpenney.net/)

[Extends Markdown](https://rawgit.com/fletcher/human-markdown-reference/master/) with tables, footnotes, maths, definition lists… and [epub generation](http://fletcherpenney.net/multimarkdown/)


# Various markup languages exist:
...
With converters in every widely-used language


# The web and Markdown

- with static site generators, you can use Markdown to maintain a site or a blog
- Nanoc, Jekyll, Hakyll…
...
You can use Markdown quickly without learning much, or deeply by learning a bit more.

- **essential:** editing and preparing module handbooks and other documents, Blackboard learning materials, web materials, quick structured content
- **advanced:** version controlled with GitHub, continuous development with a permanent URL on GitHub pages, CSS styling for HTML output, e-books…
...
- A. Markdown is already in widespread use
...
- A. not naturally web-friendly
- A. doesn't encourage semantic content
- A. Office suites don't easily transport between formats
- A. WYSIWYG only on your machine (formatting, fonts)
...
- Multiple options for editing: from plain text to dedicated visual editors
...
- Resistance to change and prior investment in existing skills
- Holding to familiar methods and software
- The ubiquitous dominance of Microsoft as a *primary* source
- Attachment to personal formatting (colours, fonts...)
- There are a few [Markdown flavours](https://github.com/jgm/CommonMark/wiki/Markdown-Flavors) although many are similar and some are trivial. There are also attempts to [standardise Markdown variations](https://github.com/jgm/CommonMark/wiki/Deployed-Extensions). However, **Multimarkdown** is likely to have everything most people commonly need.


# Markdown issues

- no *direct* way of adding maths but:
    - MultiMarkdown has maths
    -[MathJAX](https://www.mathjax.org/) JS library for HTML
- limited set of tags
- no HTML5 semantic tags
- some parsers allow inline HTML or attributes
...
- [free/paid Windows Mardown editors](http://alternativeto.net/software/ia-writer/?platform=windows)
